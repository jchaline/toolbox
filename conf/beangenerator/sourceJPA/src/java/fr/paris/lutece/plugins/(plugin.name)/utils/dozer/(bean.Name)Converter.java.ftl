...
import fr.paris.lutece.plugins.genericjpa.utils.dozer.GenericJPADozerConverter;
 ...
 */
public class ${bean.name?cap_first}Converter extends GenericJPADozerConverter<${bean.name?cap_first}DTO,${bean.name?cap_first}>{
